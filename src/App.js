    ...
    return (
      <div className="main">
       <div className="template-list-container">
        <div className="title"><h1 className="text-center">Create your Mem</h1></div>
          <div className="mem-container">
            <div className="input-group input-text">
              <input className="form-control form-input" placeholder="Upper text" name="text0" onChange={this.upperTextChanged.bind(this)}/>
            </div>
            <div className="input-group input-text">
              <input className="form-control form-input" placeholder="Lower text" name="text1" onChange={this.lowerTextChanged.bind(this)}/>
            </div>
            <div>
              <button className="add_button" type="submit" onClick={this.buttonClicked.bind(this)}>Add caption</button>
            </div>
            <div>
...
class TemplateContainer extends Component {
  ...
  render() {
    ...
    const templateNode = templates.map((template)=> {
      return (
        <NavLink to={"/create_meme/" + template.index}>
          <Template url={template.url}/>
        </NavLink>
      )
    });
